...
<body class="bg-white text-gray-800">
    ...
    <section class="relative bg-cover bg-center h-[400px] flex items-center justify-center rounded-b-lg overflow-hidden" style="background-image: url('{{ asset('https://placehold.co/1200x400/FEEBC8/FF7B00?text=Contact+Us') }}');">
